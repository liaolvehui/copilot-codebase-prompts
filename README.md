...
Use this prompt when you have just taken over a project and want Copilot to first understand the repository without modifying production code.
...
Use this after the initial repository scan. The goal is to move beyond technical structure and understand how the actual business works through the code.
...
Use this only after the architecture and important business flows have been analyzed and verified. The goal is to convert that knowledge into reusable AI context for future development.
...
The key principle throughout all three stages is simple:

> **Verified project knowledge is more valuable than generic framework knowledge.**

Copilot already understands Java, Spring, Maven, Git, and common software patterns. The most useful repository-specific context is the information it cannot reliably infer on its own: business rules, hidden dependencies, internal conventions, state transitions, integration constraints, and non-obvious design decisions.
